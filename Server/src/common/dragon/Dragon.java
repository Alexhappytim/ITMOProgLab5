...
public class Dragon implements Comparable<Dragon>, Serializable {
    ...
    public Dragon(Long id, String name, Coordinates coordinates, Date creationDate, Long age, boolean speaking, Color color, DragonType type, DragonHead head, Integer authorId) {
        setId(id);
        setName(name);
